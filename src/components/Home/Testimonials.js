...
const Testimonials = () => {
    useEffect(() => {
        const swiper = new Swiper(".mySwiper", {
          ...
          navigation: {
            nextEl: ".swiper-button-next", // Make sure the class is correct
            prevEl: ".swiper-button-prev", // Make sure the class is correct
          },
          breakpoints: {
            0: {
              slidesPerView: 1,
  ...
  return (
    <section className="py-24" style={{ background: "linear-gradient(143.6deg, rgba(192, 132, 252, 0) 20.79%, rgba(232, 121, 249, 0.26) 40.92%, rgba(204, 171, 238, 0) 70.35%)" }}>
