...
<div className="absolute inset-0 z-0 lg:hidden">
  <div className="w-full h-full relative">
    ...
    {/* Transparent Overlay */}
    <div className="absolute inset-0 bg-black opacity-70 backdrop-blur-xl z-10"></div> {/* Adjust opacity as needed */}
      ...
      <section className="relative mx-auto max-w-screen-xl px-4 pt-24 pb-12 lg:flex items-center md:px-8">
        ...
        <div className="relative z-10 flex-1 space-y-4 text-center lg:text-left">
          <h1 className="text-white md:text-black font-bold text-2xl md:text-4xl xl:text-5xl">
            One page Template for <br />
            <span className="bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
              Digital agency
            </span>
          </h1>
          <p className="text-white md:text-gray-500 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
