  ...
  return (
    <div>
        <section 
                    ...
                    style={{ backgroundImage: "url('https://www.mediaheroes.com.au/wp-content/uploads/2023/09/website-testimonials-media-heroes-banner.webp')" }} // Replace with a suitable image
                    >
                    {/* Overlay */}
